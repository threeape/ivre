...
def main():
    ...
    parser.add_argument(
        "--limit", "-l", type=int, help="Ouput at most LIMIT results."
    )
    parser.add_argument(
        "--skip", type=int, default=0, help="Skip first SKIP results."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--fields", nargs="+", help="Display these fields for each entry."
    )
